...
data={
    'loginId': '15156751916',
    'password2': getPwd('123456789x'),
    'keepLogin': 'false',
    'ua': '125#',
    'umidGetStatusVal': '255',
    'screenPixel': '1536x864',
    'navlanguage': 'zh-CN',
    'navUserAgent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36',
    'navPlatform': 'Win32',
    'appName': 'taobao',
    'appEntrance': 'taobao_pc',
    '_csrf_token': '1lxysSeei6R2E3lVGNzKr4',
    'umidToken': '9590b04c610829e02c3c5d09b4454ce542233c95',
    'hsiz': '14c6025d27848402b55d545e210cb10b',
    'bizParams': '',
    'style': 'default',
    'appkey': '00000000',
    'from': 'tb',
    'isMobile': 'false',
    'lang': 'zh_CN',
    'returnUrl': 'http://i.taobao.com/my_taobao.htm?spm=a21bo.2017.1997525045.1.5af911d9kBnUaf',
    'fromSite': '0'
}
headers={
...
print(html.text)
url=html.json()['content']['data']['redirectUrl']
print(url)

keyword=input(">>>输入要爬取的商品>>>")
for i in range(0,132,44):
    html2=session.get('https://s.taobao.com/search?q='+keyword)
    re_content=re.compile('"raw_title":"(.*?)","pic_url":"(.*?)","detail_url":"(.*?)","view_price":"(.*?)","view_fee":.*?"item_loc":"(.*?)","view_sales":"(.*?)","comment_count":.*?"nick":"(.*?)"',re.S|re.I)
    result=re_content.findall(html2.text)
    for r in result:
        print(r)
    print('新的一页')
